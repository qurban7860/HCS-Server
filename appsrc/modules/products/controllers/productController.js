  ...
  for(let product of products) {
    ...
    if(EXPORT_UUID) {
      finalDataObj = {
        ...
        shippingDate:product?.shippingDate === null ? "":product?.shippingDate?.replace(/"/g,"'")+'',
        installationDate:product?.installationDate === null ? "":product?.installationDate?.replace(/"/g,"'")+'',
