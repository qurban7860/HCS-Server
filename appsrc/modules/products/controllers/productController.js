  ...
  for(let product of products) {
    ...
    if(EXPORT_UUID) {
      finalDataObj = {
        ...
        workOrderRef:product?.workOrderRef?.replace(/"/g,"'")+'',
        financialCompany:product?.financialCompany?.name?.replace(/"/g,"'")+'',
        billingSite:product?.billingSite?.name?.replace(/"/g,"'")+'',
        shippingDate:product?.shippingDate?.replace(/"/g,"'")+'',
        installationDate:product?.installationDate?.replace(/"/g,"'")+'',
        installationSite:product?.installationSite?.name?.replace(/"/g,"'")+'',
        siteMilestone:product?.siteMilestone?.replace(/"/g,"'")+'',
        accountManager:product?.accountManager?.firstName?.replace(/"/g,"'")+'',
        projectManager:product?.projectManager?.firstName?.replace(/"/g,"'")+'',
        supportManager:product?.supportManager?.firstName?.replace(/"/g,"'")+'',
        supportExpireDate:product?.supportExpireDate?.replace(/"/g,"'")+'',
