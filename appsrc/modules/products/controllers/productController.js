  ...
  for(let product of products) {
    ...
    if(EXPORT_UUID) {
      finalDataObj = {
        ...
        shippingDate:product?.shippingDate === undefined ? "":product?.shippingDate.replace(/"/g,"'")+'',
        installationDate:product?.installationDate === undefined ? "":product?.installationDate.replace(/"/g,"'")+'',
        ...
        supportExpireDate:product?.supportExpireDate === undefined ? "":product?.supportExpireDate.replace(/"/g,"'")+'',
