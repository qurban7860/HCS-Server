...
exports.getProductCheckItem = async (req, res, next) => {
  ...
  async function callbackFunc(error, response) {
    if (error) {
      ...
      let serviceReportTemplates = await ProductServiceReportTemplate.find({"checkItemLists.checkItems":req.params.id, isArchived:false, isActive:true},{'docTitle':1, 'docVersionNo': 1});
...
exports.getProductCheckItems = async (req, res, next) => {
  ...
  this.orderBy = { name: 1 };
  this.dbservice.getObjectList(req, ProductCheckItem, this.fields, this.query, this.orderBy, this.populate, callbackFunc);
