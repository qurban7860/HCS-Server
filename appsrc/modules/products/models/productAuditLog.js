...
const docSchema = new Schema({
    recordType: {
        ...
        enum: ['PRODUCT', 'PRODUCTCATEGORY', 'PRODUCTLICENSE', 'PRODUCTMODEL', 'PRODUCTSTATUS', 'PRODUCTSUPPLIER',
            ...
            , 'PRODUCTTOOLINSTALLED', 'PRODUCTCONNECTION', 'PRODUCTDRAWING', 'PRODUCTCHECKITEM', 'PRODUCTSERVICEREPORTTEMPLATE',
            'PRODUCTSERVICEREPORTS', 'PRODUCTCHECKITEMCATEGORY', 'PRODUCTPROFILE', 'PRODUCTSERVICEREPORTVALUE', 'CATEGORYGROUP'],
        default: 'OTHER'
    },
