...
this.populate = [
  { path: 'statusType', select: 'name icon slug color isResolved displayOrderNo' },
...
exports.getTicketCountByStatus = async (req, res, next) => {
  try {
...
function getDocFromReq(req, reqType) {
  ...
  const allowedFields = ["name", "description", "statusType", "slug", "displayOrderNo", "icon", "color", "displayOrderNo", "isDefault", "isActive", "isArchived", "isResolved"];
