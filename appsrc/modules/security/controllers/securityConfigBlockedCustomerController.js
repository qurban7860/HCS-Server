...
exports.searchSecurityConfigBlockedCustomer = async (req, res, next) => {
  ...
  if (!errors.isEmpty()) {
    ...
    this.dbservice.getObjectList(req, SecurityConfigBlockedCustomer, this.fields, this.query, this.orderBy, this.populateList, callbackFunc);
    ...
    function callbackFunc(error, securityConfigs) {
      ...
      if (error) {
        ...
        if(searchName) {
          let filterSecurityConfigBlockedCustomers = [];
          ...
          for(let securityConfig of securityConfigs) {
            ...
            if(name.search(searchName.toLowerCase())>-1) {
              filterSecurityConfigBlockedCustomers.push(securityConfig);
            }
          }

          securityConfigs = filterSecurityConfigBlockedCustomers;
...
exports.getSecurityConfigBlockedCustomer = async (req, res, next) => {
  this.query = req.query != "undefined" ? req.query : {};
...
exports.getSecurityConfigBlockedCustomers = async (req, res, next) => {
  this.query = req.query != "undefined" ? req.query : {};
  this.dbservice.getObjectList(req, SecurityConfigBlockedCustomer, this.fields, this.query, this.orderBy, this.populateList, callbackFunc);
  function callbackFunc(error, response) {
    if (error) {
...
exports.deleteSecurityConfigBlockedCustomer = async (req, res, next) => {
...
exports.postSecurityConfigBlockedCustomer = async (req, res, next) => {
  const errors = validationResult(req);
  if (!errors.isEmpty()) {
...
exports.patchSecurityConfigBlockedCustomer = async (req, res, next) => {
  const errors = validationResult(req);
  //console.log('calling patchSecurityConfigBlockedCustomer');
  if (!errors.isEmpty()) {
    res.status(StatusCodes.BAD_REQUEST).send(getReasonPhrase(StatusCodes.BAD_REQUEST));
  } else {
