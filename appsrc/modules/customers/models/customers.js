...
const customerSchema = new Schema({
        ...
        sites: [{ type: Schema.ObjectId, ref: 'customersites' }],
        primaryBillingContact: { type: Schema.Types.ObjectId, ref: 'customercontacts' },
        primaryTechnicalContact: { type: Schema.Types.ObjectId, ref: 'customercontacts' },
